...
public class PKCS7 {
	 ...
	 *            String类， 密钥
	 */
	public PKCS7(String keyFile, String keyPass) {
		// TODO Auto-generated constructor stub
		// 解析传密钥文件
		CertificateParse pkf = new CertificateParse(keyFile, keyPass);
	 ...
	 */
	public byte[] sign(String data) throws KeyStoreException, NoSuchAlgorithmException, CertificateException,
			FileNotFoundException, IOException, UnrecoverableKeyException, OperatorCreationException, CMSException,
	 ...
	 * @throws CMSException
	 * @throws IOException
	 *             代码参考：http://www.bouncycastle.org/docs/pkixdocs1.4/org/
	 *             bouncycastle/cms/CMSEnvelopedDataGenerator.html
	 */
	public static byte[] pk7encrypt(String text) throws CertificateEncodingException, CMSException, IOException {
		...
		CMSEnvelopedData ed = cedg.generate(ctd,
	 ...
	 * @throws IOException
	 *             代码参考：http://www.bouncycastle.org/docs/pkixdocs1.4/org/
	 *             bouncycastle/cms/CMSEnvelopedDataParser.html
	 */
